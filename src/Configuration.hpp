...
namespace Bokken
{
    ...
    struct WindowSettings
    {
        ...
        bool useNativeResolution = false; // Overrides
    ...
    struct EnvironmentConfiguration
    {
        ...
        NLOHMANN_DEFINE_TYPE_INTRUSIVE(WindowOverrides, isFullscreen, isBorderlessFullscreen, alwaysOnTop, transparent, useNativeResolution, useVsync)
